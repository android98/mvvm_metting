...
import com.example.mvvmmeeting.Adapters.Recycler_Adapter_Present_Members;
...
public class PresentMembersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_present_members);
    ...
    private void addMember(){
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog dialog = new Dialog(PresentMembersActivity.this);
                ...
                btnFromContact.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (ContextCompat.checkSelfPermission(PresentMembersActivity.this, Manifest.permission.READ_CONTACTS) == PackageManager.PERMISSION_GRANTED
                                && ContextCompat.checkSelfPermission(PresentMembersActivity.this, Manifest.permission.WRITE_CONTACTS) == PackageManager.PERMISSION_GRANTED ){
    ...
    private void injectRecyclerView() {
        ...
        recyclerMembers.setAdapter(adapterMembers);
    ...
    public void getMemberInfo() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name == "") {
                    Toast.makeText(PresentMembersActivity.this, "", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == ACCESS_CONTATC_REQUEST_CODE) {
    ...
    private void getContactInfo(String id){
        ...
        if ( !isExist ){
            ...
            Toast.makeText(PresentMembersActivity.this,"این عضو قبلا اضافه شده است.",Toast.LENGTH_SHORT).show();
        }
